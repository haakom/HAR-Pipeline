...
train_x, train_y, val, val2 = rd.build_dataset(None, "/home/guest/Documents/HAR-Pipeline/DATA/trene", 1, 19, use_most_common_label=False, print_stats=True, generate_one_hot=False, normalize_data=False)
